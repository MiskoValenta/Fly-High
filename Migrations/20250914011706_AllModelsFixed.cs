...
{
    /// <inheritdoc />
    public partial class AllModelsFixed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatchIdentifier = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SetsPlayed = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancellationReason = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MatchAttendances_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamATotalPoints = table.Column<int>(type: "int", nullable: false),
                    TeamBTotalPoints = table.Column<int>(type: "int", nullable: false),
                    WinnerTeam = table.Column<string>(type: "nvarchar(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScoreAtTime = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamATimeouts = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TeamBTimeouts = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamAScore = table.Column<int>(type: "int", nullable: false),
                    TeamBScore = table.Column<int>(type: "int", nullable: false),
                    ScoringTeam = table.Column<string>(type: "nvarchar(1)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SetPoints", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SetPoints_Sets_SetId",
                        column: x => x.SetId,
                        principalTable: "Sets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PollResponses_PollOptions_PollOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchAttendances_MatchId_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_MatchIdentifier",
                table: "Matches",
                column: "MatchIdentifier");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Players_MatchId_Team_JerseyNumber",
                table: "Players",
                columns: new[] { "MatchId", "Team", "JerseyNumber" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerStatistics_UserId_TeamId_Season",
                table: "PlayerStatistics",
                columns: new[] { "UserId", "TeamId", "Season" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PollResponses_PollId_UserId_PollOptionId",
                table: "PollResponses",
                columns: new[] { "PollId", "UserId", "PollOptionId" });

            migrationBuilder.CreateIndex(
                name: "IX_PollResponses_PollOptionId",
                table: "PollResponses",
                column: "PollOptionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Polls_TeamId_CreatedAt",
                table: "Polls",
                columns: new[] { "TeamId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_SetPoints_SetId",
                table: "SetPoints",
                column: "SetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMembers_UserId_TeamId_IsActive",
                table: "TeamMembers",
                columns: new[] { "UserId", "TeamId", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamStatistics_TeamId_Season",
                table: "TeamStatistics",
                columns: new[] { "TeamId", "Season" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TrainingAttendances_TrainingId_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trainings_TeamId_ScheduledDate",
                table: "Trainings",
                columns: new[] { "TeamId", "ScheduledDate" });
        }
